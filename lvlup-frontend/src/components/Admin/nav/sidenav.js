  ...
  render() {
    ...
    return (
      <Menu inverted vertical className="adminSidenav">
        <Menu.Item id="admin-sidenav-info">
          <Image src={this.props.loggedIn.gravatar_url ? this.props.loggedIn.gravatar_url : 'https://media.glassdoor.com/sqll/825775/galvanize-squarelogo-1429039425588.png'} shape="circular" size="tiny" alt={this.props.loggedIn.name} centered />
