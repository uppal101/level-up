  ...
  render() {
    ...
    return (
      <Menu inverted vertical className="adminSidenav">
        <Menu.Item><Image src={this.props.loggedIn.gravatar_url ? this.props.loggedIn.gravatar_url : 'https://ucarecdn.com/d50ece0e-f5e1-47fd-a492-d8561fe02ebb/'} shape="circular" size="tiny" alt={this.props.loggedIn.name} centered />
